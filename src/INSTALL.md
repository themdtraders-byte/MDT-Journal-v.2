...
## Data Storage: Guest vs. Signed-In Users

The application offers two data storage modes:

*   **Continue as Guest**: In this mode, all your journal data is stored **locally** in your browser's storage. This is fast, private, and works completely offline.
...
*   **Sign in with Google**: When you sign in with your Google account, your data is stored in **both** your browser's local storage (for speed and offline access) and securely in your private Firebase cloud database.
    *   **Cloud Sync**: This allows your data to be automatically synchronized across any device you sign in from.
