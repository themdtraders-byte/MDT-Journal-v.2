...
// This new component will be rendered inside the context provider
const AppShortcuts = () => {
    const { 
        setAccountOpen, 
        setFilterOpen, 
...
export default function MainLayoutContent({ children }: { children: React.ReactNode; }) {
    ...
    // This is the definitive gatekeeper. Do not attempt to access store data until hydrated.
    ...
    // This is the main guard. Until hydration is complete and a journal is active, show the loading screen.
