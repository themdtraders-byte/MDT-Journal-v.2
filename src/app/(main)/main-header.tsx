...
const MainHeader = () => {
    ...
    const analytics = useMemo(() => {
        if (!activeJournal || !appSettings || filteredTrades.length === 0) return null;
                    ...
                    <div className="flex items-center px-2 md:px-4 h-9">
                        ...
                        <div className="flex-1 min-w-0" />
                         <div className="flex items-center gap-0">
                            <Button onClick={handleAddTradeClick} variant="ghost" size="sm" className="h-7 px-2 icon-glow-wrapper"><PlusSquare className="h-4 w-4 mr-1"/> Add Trade</Button>
